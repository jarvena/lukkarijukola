...
var features_rastit = format_kilpailukielto_2.readFeatures(json_rastit,
  {dataProjection: 'EPSG:3857', featureProjection: 'EPSG:3857'})
var lyr_rastit = new ol.layer.Vector({
  title: '<img src="styles/legend/rastit.png" /> Venlojen rasteja',
  source: new ol.source.Vector({
    features: features_rastit,
  }),
  style: function(feature, resolution) {
    return new ol.style.Style({
...
lyr_MapAnt_0.setVisible(true);lyr_Lukkari_Jukola_vanha_georeferenced_1.setVisible(true);lyr_kilpailukielto_2.setVisible(true);lyr_kisakeskus.setVisible(true);lyr_rastit.setVisible(true);
var layersList = [lyr_MapAnt_0,lyr_Lukkari_Jukola_vanha_georeferenced_1,lyr_vinovalo,lyr_kilpailukielto_2,lyr_kisakeskus,lyr_rastit];
